 ...
 -->
			...
			<form id="login_form1" class="form-signin" method="post">
						...
						<h3 class="form-signin-heading">
							<i class="icon-lock"></i> User Sign in
						</h3>

						<input type="text" class="input-block-level" id="username" name="username" placeholder="REGISTRATION NO" required>
		...
		jQuery("#login_form1").submit(function(e)
	{
		...
		<div id="button_form" class="form-signin">
			New to BUK LMS
			<hr>
				<h3 class="form-signin-heading"><i class="icon-key"></i> Authentication</h3>
				<button data-placement="top" title="Authenticate as Student" id="signin_student" onclick="window.location='signup_student.php'" id="btn_student" name="login" class="btn btn-info" type="submit">I'm a Student</button>
				<div class="pull-right">
					<button data-placement="top" title="Authenticate as Teacher" id="signin_teacher" onclick="window.location='signup_teacher.php'" name="login" class="btn btn-info" type="submit">I'm a Course Tutor</button>
				</div>
		</div>
